    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                || value13 > 0 || value14 > 0 || value15 > 0) ;
            {
                ...
                listView3.Items.Add($"{value3}\n");
                listView4.Items.Add($"{value4}\n");
                listView5.Items.Add($"{value5}\n");
                listView6.Items.Add($"{value8}\n");
                listView7.Items.Add($"{value6}\n");
                listView8.Items.Add($"{value7}\n");
